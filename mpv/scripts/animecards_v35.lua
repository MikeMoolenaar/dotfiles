...
local SENTENCE_AUDIO_FIELD = "Context1-JP"
local SENTENCE_FIELD = "Context1-JP"
local IMAGE_FIELD = "Context1-JP"
...
local AUDIO_CLIP_PADDING = 0 --0.75
-- Optional fetch Forvo word audio if word audio field is empty in Anki.
local WORD_AUDIO_FIELD = "Expression-Audio"
...
local function add_to_last_added(ifield, afield, tfield)
  ...
  if note ~= nil then
    ...
    local new_fields = {
      [SENTENCE_FIELD]=ifield .. "<br>" .. tfield .. "<br>" .. afield
    }
